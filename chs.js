...
var cnRegReplace = new Map([
    [/^Beggar lvl (.+)$/, '乞丐 等级 $1'],
    [/^Farmer lvl (.+)$/, '农民 等级 $1'],
    [/^Fisherman lvl (.+)$/, '渔夫 等级 $1'],
    [/^Miner lvl (.+)$/, '矿工 等级 $1'],
    [/^Blacksmith lvl (.+)$/, '铁匠 等级 $1'],
    [/^Merchant lvl (.+)$/, '商人 等级 $1'],
    [/^Squire lvl (.+)$/, '扈从 等级 $1'],
    [/^Footman lvl (.+)$/, '步兵 等级 $1'],
    [/^Veteran footman lvl (.+)$/, '资深步兵 等级 $1'],
    [/^Centenary lvl (.+)$/, '百夫长 等级 $1'],
    [/^Knight lvl (.+)$/, '骑士 等级 $1'],
    [/^Veteran Knight lvl (.+)$/, '资深骑士 等级 $1'],
    [/^Holy Knight lvl (.+)$/, '圣骑士 等级 $1'],
    [/^Lieutenant General lvl (.+)$/, '中将 等级 $1'],
    [/^Student lvl (.+)$/, '学生 等级 $1'],
    [/^Apprentice Mage lvl (.+)$/, '魔法学徒 等级 $1'],
    [/^Adept Mage lvl (.+)$/, '法师达人 等级 $1'],
    [/^Master Wizard lvl (.+)$/, '大法师 等级 $1'],
    [/^Archmage lvl (.+)$/, '法宗 等级 $1'],
    [/^Chronomancer lvl (.+)$/, '时光法师 等级 $1'],
    [/^Chairman lvl (.+)$/, '主席 等级 $1'],
    [/^Imperator lvl (.+)$/, '法皇 等级 $1'],
    [/^Corrupted lvl (.+)$/, '腐化 等级 $1'],
    [/^Void Slave lvl (.+)$/, '虚空奴隶 等级 $1'],
    [/^Void Fiend lvl (.+)$/, '虚空邪魔 等级 $1'],
    [/^Abyss Anomaly lvl (.+)$/, '深渊畸体 等级 $1'],
    [/^Void Wraith lvl (.+)$/, '虚空幽魂 等级 $1'],
    [/^Void Reaver lvl (.+)$/, '虚空掠夺者 等级 $1'],
    [/^Void Lord lvl (.+)$/, '虚空领主 等级 $1'],
    [/^Abyss God lvl (.+)$/, '深渊之神 等级 $1'],
    [/^Eternal Wanderer lvl (.+)$/, '永恒浪客 等级 $1'],
    [/^Nova lvl (.+)$/, '新星 等级 $1'],
    [/^Sigma Proioxis lvl (.+)$/, '西格玛普洛伊俄克斯 等级 $1'],
    [/^Acallaris lvl (.+)$/, '阿卡拉里斯 等级 $1'],
    [/^One Above All lvl (.+)$/, '至高无上 等级 $1'],
    [/^Concentration lvl (.+)$/, '专注 等级 $1'],
    [/^Productivity lvl (.+)$/, '效率 等级 $1'],
    [/^Bargaining lvl (.+)$/, '议价 等级 $1'],
    [/^Meditation lvl (.+)$/, '冥想 等级 $1'],
    [/^Strength lvl (.+)$/, '力量 等级 $1'],
    [/^Battle Tactics lvl (.+)$/, '兵法韬略 等级 $1'],
    [/^Muscle Memory lvl (.+)$/, '肌肉记忆 等级 $1'],
    [/^Mana Control lvl (.+)$/, '控制法力 等级 $1'],
    [/^Life Essence lvl (.+)$/, '生命源质 等级 $1'],
    [/^Time Warping lvl (.+)$/, '扭曲时间 等级 $1'],
    [/^Astral Body lvl (.+)$/, '星光体 等级 $1'],
    [/^Temporal Dimension lvl (.+)$/, '时间维度 等级 $1'],
    [/^All Seeing Eye lvl (.+)$/, '全视之眼 等级 $1'],
    [/^Brainwashing lvl (.+)$/, '意识操控 等级 $1'],
    [/^Dark Influence lvl (.+)$/, '黑暗影响 等级 $1'],
    [/^Evil Control lvl (.+)$/, '邪恶控制 等级 $1'],
    [/^Intimidation lvl (.+)$/, '威胁恐吓 等级 $1'],
    [/^Demon Training lvl (.+)$/, '恶魔训练 等级 $1'],
    [/^Blood Meditation lvl (.+)$/, '血之冥想 等级 $1'],
    [/^Demon\'s Wealth lvl (.+)$/, '恶魔财富 等级 $1'],
    [/^Dark Knowledge lvl (.+)$/, '黑暗知识 等级 $1'],
    [/^Void Influence lvl (.+)$/, '虚空影响 等级 $1'],
    [/^Time Loop lvl (.+)$/, '时间循环 等级 $1'],
    [/^Evil Incarnate lvl (.+)$/, '邪恶具现 等级 $1'],
    [/^Absolute Wish lvl (.+)$/, '绝对心愿 等级 $1'],
    [/^Void Amplification lvl (.+)$/, '扩充虚空 等级 $1'],
    [/^Mind Seize lvl (.+)$/, '占据意识 等级 $1'],
    [/^Ceaseless Abyss lvl (.+)$/, '无尽深渊 等级 $1'],
    [/^Void Symbiosis lvl (.+)$/, '虚空共生 等级 $1'],
    [/^Void Embodiment lvl (.+)$/, '虚空化身 等级 $1'],
    [/^Abyss Manipulation lvl (.+)$/, '控制深渊 等级 $1'],
    [/^Cosmic Longevity lvl (.+)$/, '天地同寿 等级 $1'],
    [/^Cosmic Recollection lvl (.+)$/, '宇宙回忆 等级 $1'],
    [/^Essence Collector lvl (.+)$/, '精华汲取 等级 $1'],
    [/^Galactic Command lvl (.+)$/, '银河命令 等级 $1'],
    [/^Yin Yang lvl (.+)$/, '阴阳 等级 $1'],
    [/^Parallel Universe lvl (.+)$/, '平行宇宙 等级 $1'],
    [/^Higher Dimensions lvl (.+)$/, '高维存在 等级 $1'],
    [/^Epiphany lvl (.+)$/, '天人合一 等级 $1'],
    [/^([\.\d]+)([BDGMNOQSTUVcdgkpqtxv]+) evil$/, '$1$2 邪恶'],
    [/^([\.\d]+)([BDGMNOQSTUVcdgkpqtxv]+) essence$/, '$1$2 精华'],
    [/^ Concentration level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/([\.\dBDGMNOQSTUVcdgkpqtxv]+)$/, '专注 等级 $1/$2'],
    [/^ Productivity level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/([\.\dBDGMNOQSTUVcdgkpqtxv]+)$/, '效率 等级 $1/$2'],
    [/^ Meditation level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/([\.\dBDGMNOQSTUVcdgkpqtxv]+)$/, '冥想 等级 $1/$2'],
    [/^ Strength level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/([\.\dBDGMNOQSTUVcdgkpqtxv]+)$/, '力量 等级 $1/$2'],
    [/^ Battle Tactics level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/([\.\dBDGMNOQSTUVcdgkpqtxv]+)$/, '兵法韬略 等级 $1/$2'],
    [/^ Mana Control level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/([\.\dBDGMNOQSTUVcdgkpqtxv]+)$/, '控制法力 等级 $1/$2'],
    [/^ Concentration level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/200, Meditation level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/200$/, '专注 等级 $1/200，冥想 等级 $2/200'],
    [/^ Beggar level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '乞丐 等级 $1/10'],
    [/^ Farmer level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '农民 等级 $1/10'],
    [/^ Strength level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10, Fisherman level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '力量 等级 $1/10，渔夫 等级 $2/10'],
    [/^ Fisherman level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '渔夫 等级 $1/10'],
    [/^ Strength level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/30, Miner level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '力量 等级 $1/30，矿工 等级 $2/10'],
    [/^ Miner level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '矿工 等级 $1/10'],
    [/^ Bargaining level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/50, Blacksmith level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '议价 等级 $1/50，铁匠 等级 $2/10'],
    [/^ Bargaining level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/50$/, '议价 等级 $1/50'],
    [/^ Blacksmith level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '铁匠 等级 $1/10'],
    [/^ Strength level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/20, Squire level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '力量 等级 $1/20，扈从 等级 $2/10'],
    [/^ Squire level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '扈从 等级 $1/10'],
    [/^ Battle Tactics level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/40, Footman level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '兵法韬略 等级 $1/40，步兵 等级 $2/10'],
    [/^ Footman level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '步兵 等级 $1/10'],
    [/^ Strength level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/100, Veteran footman level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '力量 等级 $1/100，资深步兵 等级 $2/10'],
    [/^ Veteran footman level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '资深步兵 等级 $1/10'],
    [/^ Battle Tactics level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/150, Centenary level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '兵法韬略 等级 $1/150，百夫长 等级 $2/10'],
    [/^ Centenary level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '百夫长 等级 $1/10'],
    [/^ Strength level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/300, Knight level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '力量 等级 $1/300，骑士 等级 $2/10'],
    [/^ Knight level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '骑士 等级 $1/10'],
    [/^ Mana Control level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/500, Veteran Knight level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '控制法力 等级 $1/500，资深骑士 等级 $2/10'],
    [/^ Veteran Knight level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '资深骑士 等级 $1/10'],
    [/^ Mana Control level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/1.0k, Battle Tactics level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/1.0k, Holy Knight level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '控制法力 等级 $1/1.0k，兵法韬略 等级 $2/1.0k，圣骑士 等级 $3/10'],
    [/^ Mana Control level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/1.0k, Battle Tactics level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/1.0k$/, '控制法力 等级 $1/1.0k，兵法韬略 等级 $2/1.0k'],
    [/^ Mana Control level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/1.0k, Holy Knight level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '控制法力 等级 $1/1.0k，圣骑士 等级 $2/10'],
    [/^ Battle Tactics level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/1.0k, Holy Knight level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '兵法韬略 等级 $1/1.0k，圣骑士 等级 $2/10'],
    [/^ Holy Knight level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '圣骑士 等级 $1/10'],
    [/^ Mana Control level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/400, Student level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '控制法力 等级 $1/400，学生 等级 $2/10'],
    [/^ Student level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '学生 等级 $1/10'],
    [/^ Mana Control level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/700, Apprentice Mage level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '控制法力 等级 $1/700，魔法学徒 等级 $2/10'],
    [/^ Apprentice Mage level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '魔法学徒 等级 $1/10'],
    [/^ Mana Control level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/1.0k, Adept Mage level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '控制法力 等级 $1/1.0k，法师达人 等级 $2/10'],
    [/^ Adept Mage level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '法师达人 等级 $1/10'],
    [/^ Mana Control level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/1.2k, Master Wizard level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '控制法力 等级 $1/1.2k，大法师 等级 $2/10'],
    [/^ Master Wizard level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/10$/, '大法师 等级 $1/10'],
    [/^ Mana Control level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/1.5k, Meditation level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/1.5k, Archmage level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/25$/, '控制法力 等级 $1/1.5k，冥想 等级 $2/1.5k，法宗 等级 $3/25'],
    [/^ Mana Control level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/1.5k, Meditation level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/1.5k$/, '控制法力 等级 $1/1.5k，冥想 等级 $2/1.5k'],
    [/^ Mana Control level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/1.5k, Archmage level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/25$/, '控制法力 等级 $1/1.5k，法宗 等级 $2/25'],
    [/^ Meditation level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/1.5k, Archmage level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/25$/, '冥想 等级 $1/1.5k，法宗 等级 $2/25'],
    [/^ Archmage level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/25$/, '法宗 等级 $1/25'],
    [/^ Mana Control level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/2.0k, Productivity level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/2.0k, Chronomancer level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/50$/, '控制法力 等级 $1/2.0k，效率 等级 $2/2.0k，时光法师 等级 $3/50'],
    [/^ Mana Control level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/2.0k, Productivity level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/2.0k$/, '控制法力 等级 $1/2.0k，效率 等级 $2/2.0k'],
    [/^ Mana Control level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/2.0k, Chronomancer level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/50$/, '控制法力 等级 $1/2.0k，时光法师 等级 $2/50'],
    [/^ Productivity level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/2.0k, Chronomancer level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/50$/, '效率 等级 $1/2.0k，时光法师 等级 $2/50'],
    [/^ Chronomancer level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/50$/, '时光法师 等级 $1/50'],
    [/^ All Seeing Eye level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.0k, Concentration level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.0k, Chairman level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/666$/, '全视之眼 等级 $1/3.0k，专注 等级 $2/3.0k，主席 等级 $3/666'],
    [/^ All Seeing Eye level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.0k, Concentration level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.0k$/, '全视之眼 等级 $1/3.0k，专注 等级 $2/3.0k'],
    [/^ All Seeing Eye level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.0k, Chairman level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/666$/, '全视之眼 等级 $1/3.0k，主席 等级 $2/666'],
    [/^ Concentration level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.0k, Chairman level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/666$/, '专注 等级 $1/3.0k，主席 等级 $2/666'],
    [/^ All Seeing Eye level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.0k$/, '全视之眼 等级 $1/3.0k'],
    [/^ Chairman level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/666$/, '主席 等级 $1/666'],
    [/^ Corrupted level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/30$/, '腐化 等级 $1/30'],
    [/^ Brainwashing level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.0k, Void Slave level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/200$/, '意识操控 等级 $1/3.0k，虚空奴隶 等级 $2/200'],
    [/^ Brainwashing level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.0k$/, '意识操控 等级 $1/3.0k'],
    [/^ Void Slave level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/200$/, '虚空奴隶 等级 $1/200'],
    [/^ Mind Seize level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.0k, Void Fiend level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/200$/, '占据意识 等级 $1/3.0k，虚空邪魔 等级 $2/200'],
    [/^ Mind Seize level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.0k$/, '占据意识 等级 $1/3.0k'],
    [/^ Void Fiend level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/200$/, '虚空邪魔 等级 $1/200'],
    [/^ Temporal Dimension level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.4k, Abyss Anomaly level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/300$/, '时间维度 等级 $1/3.4k，深渊畸体 等级 $2/300'],
    [/^ Temporal Dimension level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.4k$/, '时间维度 等级 $1/3.4k'],
    [/^ Abyss Anomaly level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/300$/, '深渊畸体 等级 $1/300'],
    [/^ Void Amplification level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.4k, Void Wraith level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/250$/, '扩充虚空 等级 $1/3.4k，虚空幽魂 等级 $2/250'],
    [/^ Void Amplification level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.4k$/, '扩充虚空 等级 $1/3.4k'],
    [/^ Void Wraith level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/250$/, '虚空幽魂 等级 $1/250'],
    [/^ Void Symbiosis level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.8k, Void Reaver level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/150$/, '虚空共生 等级 $1/3.8k，虚空掠夺者 等级 $2/150'],
    [/^ Void Symbiosis level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.8k$/, '虚空共生 等级 $1/3.8k'],
    [/^ Void Reaver level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/150$/, '虚空掠夺者 等级 $1/150'],
    [/^ Void Embodiment level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/4.7k, Void Lord level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/750$/, '虚空化身 等级 $1/4.7k，虚空领主 等级 $2/750'],
    [/^ Void Embodiment level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/4.7k$/, '虚空化身 等级 $1/4.7k'],
    [/^ Void Lord level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/750$/, '虚空领主 等级 $1/750'],
    [/^ Eternal Wanderer level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/15, Cosmic Longevity level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/4.0k$/, '永恒浪客 等级 $1/15，天地同寿 等级 $2/4.0k'],
    [/^ Eternal Wanderer level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/15$/, '永恒浪客 等级 $1/15'],
    [/^ Cosmic Longevity level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/4.0k$/, '天地同寿 等级 $1/4.0k'],
    [/^ Nova level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/200, Cosmic Recollection level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/4.5k$/, '新星 等级 $1/200，宇宙回忆 等级 $2/4.5k'],
    [/^ Nova level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/200$/, '新星 等级 $1/200'],
    [/^ Cosmic Recollection level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/4.5k$/, '宇宙回忆 等级 $1/4.5k'],
    [/^ Galactic Command level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/5.0k, Sigma Proioxis level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/1.0k$/, '银河命令 等级 $1/5.0k，西格玛普洛伊俄克斯 等级 $2/1.0k'],
    [/^ Galactic Command level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/5.0k$/, '银河命令 等级 $1/5.0k'],
    [/^ Sigma Proioxis level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/1.0k$/, '西格玛普洛伊俄克斯 等级 $1/1.0k'],
    [/^ Meditation level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/6.3k, Acallaris level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/1.4k$/, '冥想 等级 $1/6.3k，阿卡拉里斯 等级 $2/1.4k'],
    ...
    [/^ Chairman level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/100$/, '主席 等级 $1/100'],
    [/^ Imperator level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/100$/, '法皇 等级 $1/100'],
    [/^ Void Slave level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/25, Chairman level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/300$/, '虚空奴隶 等级 $1/25，主席 等级 $2/300'],
    [/^ Void Slave level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/25$/, '虚空奴隶 等级 $1/25'],
    [/^ Chairman level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/300$/, '主席 等级 $1/300'],
    [/^ Void Slave level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/100, Absolute Wish level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.0k$/, '虚空奴隶 等级 $1/100，绝对心愿 等级 $2/3.0k'],
    [/^ Void Slave level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/100$/, '虚空奴隶 等级 $1/100'],
    [/^ Absolute Wish level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.0k$/, '绝对心愿 等级 $1/3.0k'],
    [/^ Void Amplification level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.0k$/, '扩充虚空 等级 $1/3.0k'],
    [/^ Void Influence level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/4.0k, Abyss Anomaly level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/50$/, '虚空影响 等级 $1/4.0k，深渊畸体 等级 $2/50'],
    [/^ Void Influence level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/4.0k$/, '虚空影响 等级 $1/4.0k'],
    [/^ Abyss Anomaly level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/50$/, '深渊畸体 等级 $1/50'],
    [/^ Ceaseless Abyss level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.5k, Void Reaver level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/50$/, '无尽深渊 等级 $1/3.5k，虚空掠夺者 等级 $2/50'],
    [/^ Ceaseless Abyss level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.5k$/, '无尽深渊 等级 $1/3.5k'],
    [/^ Void Reaver level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/50$/, '虚空掠夺者 等级 $1/50'],
    [/^ Dark Influence level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/4.6k, Void Lord level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/50$/, '黑暗影响 等级 $1/4.6k，虚空领主 等级 $2/50'],
    [/^ Dark Influence level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/4.6k$/, '黑暗影响 等级 $1/4.6k'],
    [/^ Void Lord level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/50$/, '虚空领主 等级 $1/50'],
    [/^ Abyss God level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/350, Dark Influence level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/6.0k, Void Influence level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/6.0k$/, '深渊之神 等级 $1/350，黑暗影响 等级 $2/6.0k，虚空影响 等级 $3/6.0k'],
    [/^ Abyss God level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/350, Dark Influence level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/6.0k$/, '深渊之神 等级 $1/350，黑暗影响 等级 $2/6.0k'],
    [/^ Abyss God level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/350, Void Influence level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/6.0k$/, '深渊之神 等级 $1/350，虚空影响 等级 $2/6.0k'],
    [/^ Dark Influence level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/6.0k, Void Influence level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/6.0k$/, '黑暗影响 等级 $1/6.0k，虚空影响 等级 $2/6.0k'],
    [/^ Abyss God level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/350$/, '深渊之神 等级 $1/350'],
    [/^ Dark Influence level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/6.0k$/, '黑暗影响 等级 $1/6.0k'],
    [/^ Void Influence level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/6.0k$/, '虚空影响 等级 $1/6.0k'],
    [/^ Eternal Wanderer level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/1$/, '永恒浪客 等级 $1/1'],
    [/^ Nova level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/50, Meditation level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/4.2k, Mind Seize level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.0k$/, '新星 等级 $1/50，冥想 等级 $2/4.2k，占据意识 等级 $3/3.0k'],
    [/^ Nova level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/50, Meditation level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/4.2k$/, '新星 等级 $1/50，冥想 等级 $2/4.2k'],
    [/^ Nova level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/50, Mind Seize level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.0k$/, '新星 等级 $1/50，占据意识 等级 $2/3.0k'],
    [/^ Meditation level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/4.2k, Mind Seize level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.0k$/, '冥想 等级 $1/4.2k，占据意识 等级 $2/3.0k'],
    [/^ Nova level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/50$/, '新星 等级 $1/50'],
    [/^ Mind Seize level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/3.0k$/, '占据意识 等级 $1/3.0k'],
    [/^ Sigma Proioxis level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/500, Absolute Wish level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/4.9k, Dark Knowledge level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/6.3k$/, '西格玛普洛伊俄克斯 等级 $1/500，绝对心愿 等级 $2/4.9k，黑暗知识 等级 $3/6.3k'],
    [/^ Sigma Proioxis level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/500, Absolute Wish level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/4.9k$/, '西格玛普洛伊俄克斯 等级 $1/500，绝对心愿 等级 $2/4.9k'],
    [/^ Sigma Proioxis level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/500, Dark Knowledge level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/6.3k$/, '西格玛普洛伊俄克斯 等级 $1/500，黑暗知识 等级 $2/6.3k'],
    [/^ Absolute Wish level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/4.9k, Dark Knowledge level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/6.3k$/, '绝对心愿 等级 $1/4.9k，黑暗知识 等级 $2/6.3k'],
    [/^ Sigma Proioxis level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/500$/, '西格玛普洛伊俄克斯 等级 $1/500'],
    [/^ Absolute Wish level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/4.9k$/, '绝对心愿 等级 $1/4.9k'],
    [/^ Dark Knowledge level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/6.3k$/, '黑暗知识 等级 $1/6.3k'],
    [/^ Essence Collector level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/5.0k, Bargaining level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/5.0k$/, '精华汲取 等级 $1/5.0k，议价 等级 $2/5.0k'],
    [/^ Essence Collector level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/5.0k$/, '精华汲取 等级 $1/5.0k'],
    [/^ Bargaining level ([\.\dBDGMNOQSTUVcdgkpqtxv]+)\/5.0k$/, '议价 等级 $1/5.0k'],
]);